...
def get_save_folder(base: str, marca: str, month_folder: str) -> Path:
    """Estructura: base / Mes Año / MARCA / testigo"""
...
def process_file(df, source, selected_brands, base_path, month_folder, prog_bar, status_txt):
    ...
    for i, (_, row) in enumerate(df.iterrows()):
        ...
        results.append({
            ...
            "Archivo":          fname or "",
            "Error":            err or "",
            "Oferta Comercial": has_offer(desc),
            "Texto":            desc[:300] if has_offer(desc) else "",
        })
        ...
        if not selected_brands:
            ...
            for uf in uploaded_files:
                ...
                try:
                    ...
                    label = (
                        "Auditsa  (impreso / radio / tele)"
                        if source == "auditsa"
                        else "Admetricks  (online)"
                    )
